...
https://knight-isolation.herokuapp.com/
...
def custom_score_2(game, player):
    ...
    heuristic = float(len(legal_moves) - len(opponent_legal_moves))
...
def custom_score_3(game, player):
    ...
    """
    legal_moves = game.get_legal_moves(player)
    heuristic = float(len(legal_moves))
...
class MinimaxPlayer(IsolationPlayer):
    ...
    def minimax(self, game, depth):
        ...
        **********************************************************************
        ...
        best_move, score = self.maxvalue(game, depth)
    ...
    def maxvalue(self, game, depth):
        ...
        for legal_move in legal_moves:
            game_copy = game.forecast_move(legal_move)
            legal_move_checked, move_value = self.minvalue(game_copy, depth - 1)
    ...
    def minvalue(self, game, depth):
        ...
        for legal_move in legal_moves:
            game_copy = game.forecast_move(legal_move)
            legal_move_checked, move_value = self.maxvalue(game_copy, depth - 1)
            if move_value < best_value:
                best_move = legal_move_checked
                best_value = move_value
...
class AlphaBetaPlayer(IsolationPlayer):
    ...
    def alphabeta(self, game, depth, alpha=float("-inf"), beta=float("inf")):
        ...
        **********************************************************************
        ...
        best_move, score = self.maxvalue(game, depth, alpha, beta)
    ...
    def maxvalue(self, game, depth, alpha, beta):
        ...
        for legal_move in legal_moves:
            game_copy = game.forecast_move(legal_move)
            legal_move_checked, move_value = self.minvalue(game_copy, depth - 1, alpha, beta)
    ...
    def minvalue(self, game, depth, alpha, beta):
        ...
        for legal_move in legal_moves:
            game_copy = game.forecast_move(legal_move)
            legal_move_checked, move_value = self.maxvalue(game_copy, depth - 1, alpha, beta)
